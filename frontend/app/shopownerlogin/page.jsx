        ...
        <div className="lg:w-1/2 flex flex-col items-center justify-center p-6 lg:p-16">
          <div className="w-full max-w-[400px]">
            ...
            <div className="flex border-b-2 border-gray-100 mb-10 w-full">
              <Link href="/shopownerlogin" className="flex-1 text-center py-3.5 font-bold text-blue-600 border-b-2 border-blue-600 -mb-[2px]">
                Login
              </Link>
              <Link href="/shopownersignup" className="flex-1 text-center py-3.5 font-semibold text-gray-500 hover:text-gray-800 transition-colors">
                Sign Up
              </Link>
            </div>
            ...
            <form onSubmit={handleLogin} >
              ...
              <p className="text-center text-sm text-gray-600 font-medium">
                Don't have an account? <Link href="/shopownersignup" className="font-bold text-blue-600 hover:underline">Sign Up</Link>
              </p>
            </form>
          </div>
        </div>
