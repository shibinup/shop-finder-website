...
export default function AddShop() {
  // : Two separate states — previews for display, files for upload
  ...
  // : Store actual File object in `files`, blob URL in `previews`
  const handleImageChange = (index, e) => {
    const file = e.target.files[0];
    if (!file) return;

    const newFiles = [...files];
    newFiles[index] = file; // real File object for FormData
    setFiles(newFiles);

    const newPreviews = [...previews];
    newPreviews[index] = URL.createObjectURL(file); // blob URL only for <img> preview
    setPreviews(newPreviews);
  };

  //  Revoke blob URL to prevent memory leaks, clear both states
          ...
          <form className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-7 space-y-8">
              <div className="bg-white rounded-[2rem] p-6 md:p-8 shadow-sm border border-gray-100/80">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3.5 rounded-xl border border-gray-200 bg-gray-50/50 focus:bg-white focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all outline-none font-medium text-gray-800 placeholder-gray-400"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <select value={city} onChange={handleCityChange} className="w-full px-4 py-3.5 rounded-xl border border-gray-200 bg-gray-50/50 focus:bg-white focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all outline-none appearance-none font-medium text-gray-800">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      placeholder="Should enter same as logged email"
                      className="w-full px-4 py-3.5 rounded-xl border border-gray-200 bg-gray-50/50 focus:bg-white focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all outline-none font-medium text-gray-800 placeholder-gray-400"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      placeholder="Should same as logged email password"
                      className="w-full px-4 py-3.5 rounded-xl border border-gray-200 bg-gray-50/50 focus:bg-white focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all outline-none font-medium text-gray-800 placeholder-gray-400"
                    />
                  </div>
                ...
                {/*  Images Upload Area — uses previews[] for display, files[] for upload */}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    {[0, 1, 2].map((index) => (
                      <div key={index} className="relative group">
                        {previews[index] ? (
                          // Show preview using blob URL from `previews` state
                          ...
                          <label
                            ...
                            className="h-40 w-full rounded-2xl border-2 border-dashed border-blue-200 bg-blue-50/30 hover:bg-blue-50/80 flex flex-col items-center justify-center cursor-pointer transition-colors text-center p-4 group"
                          >
                            ...
                            {/*  FIX: Use id/htmlFor pattern for reliable React file input */}
                            <input
                ...
                <div className="mt-8 space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-xs font-bold text-gray-400 bg-gray-100 px-2 py-1 rounded-md">{description.length}/300</span>
                  </div>
                  <textarea
                    value={description}
                ...
                <div className="mt-8 hidden lg:block">
                  <button
                    ...
                    type="button"
                    className="w-full py-4 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-2xl shadow-xl shadow-blue-600/20 transition-all text-lg flex items-center justify-center gap-2"
                  >
                    Create Shop
                  </button>
                </div>
            ...
            <div className="lg:col-span-5 space-y-8">
              <div className="bg-white rounded-[2rem] p-6 md:p-8 shadow-sm border border-gray-100/80">
                ...
                <div className="space-y-5">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-3.5 rounded-xl border border-gray-200 bg-gray-50/50 focus:bg-white focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all outline-none pr-12 font-medium text-gray-800 placeholder-gray-400"
                      />
                  ...
                  <div className="w-full h-56 bg-gray-100 rounded-2xl border border-gray-200 overflow-hidden relative shadow-inner">
                    <div className="absolute inset-0 bg-[#e5e3df] opacity-70"></div>
                    ...
                    <div className="absolute right-3 top-3 flex flex-col bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                      <button type="button" className="p-2.5 border-b border-gray-100 hover:bg-gray-50 text-gray-600 transition-colors">
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                        </svg>
                      </button>
                      <button type="button" className="p-2.5 hover:bg-gray-50 text-gray-600 transition-colors">
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {/* LocationPicker component — keep your import at the top */}
              {/* <LocationPicker /> */}
